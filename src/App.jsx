                ...
                return (
                  <div key={tab.id} className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="relative -top-5 mx-2 z-50 grid h-14 w-14 flex-shrink-0 place-items-center rounded-full bg-accent-primary text-app-bg transition shadow-lg hover:shadow-xl active:scale-90 border-[4px] border-[var(--app-bg)]"
                    >
